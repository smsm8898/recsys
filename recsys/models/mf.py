...
class MatrixFactorization(torch.nn.Module):
    ...
    def forward(self, features: dict[str, torch.LongTensor]) -> torch.FloatTensor:
        emb1 = self.sparse_arch[self.sparse_feature_names[0]](features[self.sparse_feature_names[0]])
        emb2 = self.sparse_arch[self.sparse_feature_names[1]](features[self.sparse_feature_names[1]])
